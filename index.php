...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/from-messy-to-spatial.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">FLOOR PLAN</a></h5>
                                <p>Floor plans are an invaluable addition to your real estate marketing campaign. When buyers see the layout of a property they can begin to imagine themselves living in it</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">DIGITAL RESTYLING</a></h5>
                                <p>Want to show the potential of your property? See your home or office completely refurbished. Digital Restyling increases the selling and leasing potential of your house!</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-list text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">3D FLOOR PLAN</a></h5>
                                <p>3D Floor Plans are designed to execute a clear and simple 3d illustration of the layout of a property. This serves the purpose perfectly…</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">REAL ESTATE PHOTO EDITING</a></h5>
                                <p>It all starts with a great picture. In fact, your property pictures can make, or break, your only chance to appeal to buyers. Photo Editing is the fastest and most cost-effective way to generate traffic and, ultimately, sales.s</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/IMG_6161-2-2048x1728.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We guarantee 100% and superb quality on your products..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">GREAT VALUE.</h5>
										<p>Great value for money, affordable and effective.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">CREATIVE IDEA.</h5>
										<p>The creative team gives you good idea about your better business.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Step 1: Draw</h5>
                            <p>Import the floor plan or sketch in 2D, and we build the 3D rooms for you, even with complex multi-floor building structures</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Step 2: Decorate</h5>
                            <p>Effortlessly decorate the rooms with 3D furniture from our 300,000+ model library or your own models with the simple drag.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Step 3: Visualize</h5>
                            <p>Easily render photo realistic images, panoramas, interactive virtual tour or even animated videos on your browser within minutes!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--	Achievement
        ============================================================-->
        <div class="full-row overlay-secondary" style="background-image: url('images/RoomSketcher-New-High-Res-3D-Photos-and-360-Views.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
